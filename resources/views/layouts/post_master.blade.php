                        ...
                        @if( count($Fastmenu) )
                            @foreach($Fastmenu as $item)
                                <li class="item">
                                    <a href="{{ $item->uri }}">
                                        <div class="thumbnail">
                                            <img src="{{ $item->icon->specs[0]->file_fullpath }}"
                                                 alt="{{ $item->title }}">
                                        </div>
                ...
                <div class="body">
                    <ul class="">
                        @foreach($hotNews as $hot)
                            <li class="item">
                                <div class="thumbnail">
                                    <img src="/{{ $hot->thumbnail->specs->last()->file_fullpath }}"
                                         alt="{{ $hot->thumbnail->name }}">
                                </div>
                                <a href="{{ url()->route('showNews', $hot->title_seo) }}"
                                   class="title">{{ $hot->title }}</a>
                            </li>
                        @endforeach
