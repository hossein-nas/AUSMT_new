...
@section('content')
    <div class="form-group">
        ...
        @if($p->post_type_id == 1)
            @include('old_cpanel.pages.includes.inc_for_edit.edit_post')
        @elseif($p->post_type_id == 2)
            @include('old_cpanel.pages.includes.inc_for_edit.edit_page')
        @elseif($p->post_type_id == 3)
            @include('old_cpanel.pages.includes.inc_for_edit.edit_notfication')
        @elseif($p->post_type_id == 4)
            @include('old_cpanel.pages.includes.inc_for_edit.edit_seminar')
        @elseif($p->post_type_id == 5)
            @include('old_cpanel.pages.includes.inc_for_edit.edit_other')
        @elseif($p->post_type_id == 6)
            @include('old_cpanel.pages.includes.inc_for_edit.edit_incoming')
        @endif
